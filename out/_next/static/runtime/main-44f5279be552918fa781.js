;(window.webpackJsonp = window.webpackJsonp || []).push([
  [4],
  {
    ...
    1048: function(e, t, r) {
      ...
      ;(r.p = ''.concat(I, '/_next/')),
        g.setAssetPrefix(I),
        y.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: A })
      var M = (0, v.getURL)(),
        N = new m.default(k, I)
            ...
            function(e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  ...
                  case 22:
                    return (
                      (t.router = j = (0, f.createRouter)(P, b, M, {
                        initialProps: x,
                        pageLoader: N,
                        App: H,
                        Component: G,
                      ...
                      z({ App: H, Component: G, props: x, err: n, emitter: D }),
                      e.abrupt('return', D)
                    )
                  case 26:
                  case 'end':
                    ...
                    case 8:
                      return (
                        ...
                        (0, v.loadGetInitialProps)(r, {
                          Component: L,
                          router: j,
                          ctx: { err: n, pathname: P, query: b, asPath: M },
                        })
                      )
                    case 10:
                      e.t0 = e.sent
                  ...
                  switch ((e.prev = e.next)) {
                    case 0:
                      ...
                      return (
                        ...
                        (0, v.loadGetInitialProps)(r, {
                          Component: n,
                          router: j,
                          ctx: { err: c, pathname: h, query: m, asPath: g },
                        })
                      )
                    case 5:
                      a = e.sent
                    case 6:
                      ;(n = n || O.Component),
                        (a = a || O.props),
                        (y = (0, o.default)(
                          { Component: n, err: c, router: j, headManager: S },
                          a
                        )),
                        (O = y),
                        l.emit('before-reactdom-render', {
                          Component: n,
                          ErrorComponent: L,
                          appProps: y,
                        }),
                        ...
                        (w = p.default.createElement(
                          E.default,
                          { onError: _ },
                          p.default.createElement(r, y)
                        )),
                        (x = q),
                        $ && 'function' == typeof d.default.hydrate
                          ? (d.default.hydrate(w, x), ($ = !1))
                          : d.default.render(w, x),
                        l.emit('after-reactdom-render', {
                          Component: n,
                          ErrorComponent: L,
                          appProps: y,
                        })
